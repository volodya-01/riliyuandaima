<template>
  <div class="outbox">
    <div class="leftoutbox">
      <div class="leftoutbox_topoutbox">
        ...
        <div class="leftoutbox_topoutbox_right">
          ...
          <span class="span_slect_box">
            <span class="sanjiaoxing1"></span>
            <el-select v-model="value" @change="currentSel1">
              <el-option
      ...
      <div class="leftoutbox_downoutbox">
        ...
        <div class="leftoutbox_downoutbox_right">
          ...
          <span class="span_slect_box">
            <span class="sanjiaoxing2"></span>
            <el-select v-model="valuemonth" @change="currentSel2">
              <el-option
    ...
    <div class="centeroutbox">
      <swiper3 ref="myswiper3child"/>
    </div>
    <div class="rightoutbox" @click="todayriliapi">
      <div class="rightoutbox_topoutbox">{{value}}年</div>
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(this.SelectDayCardDatamouted());
  ...
  methods: {
      ...
      SelectDayCardData.yearMonth = _this.value + _this.valuemonth + "";
      console.log("SelectDayCardData");
      console.log(SelectDayCardData);
      _this.$axios
        .post(
            "https://www.easy-mock.com/mock/5c95dc114446ae135829fa9b/example/mockApi/getUserList",
        ...
        .then(res => {
          ...
          _this.$emit("my-rilievent", res);
          Bus.$emit("geteventi", 0);
          _this.$nextTick(_this.$refs.myswiper3child.lubolocation(1));
          console.log(res);
        })
        .catch(error => {
          /*  console.log(error); */
    ...
    todayriliapi() {
      ...
      this.$axios
        ...
        .then(res => {
          ...
          Bus.$emit(
            "todayriliapirestoswiper3i",
            Number(new Date().getDate() - 1)
          );
         /*  this.$emit("my-rilievent", res); */
          Bus.$emit("geteventi", 0);
            this.$refs.myswiper3child.lubolocation(1)
          console.log(res);
        })
        .catch(error => {
          /*  console.log(error); */
    ...
    currentSel1(selVal1) {
      ...
      Bus.$emit("rilitoswiper3i", 0);
      this.$nextTick(this.$refs.myswiper3child.lubolocation(0));
    ...
    parentHandleclick(e) {
      ...
      this.$axios
        ...
        .then(res => {
          Bus.$emit("SelectDayCardDatares", res);
          self.$emit("my-rilievent", res);
          Bus.$emit("geteventi", 0);
          /* 定时刷新日历接口调用子组件swiper3的轮播滚动到指定位置的方法 */
          self.$refs.myswiper3child.lubolocation(1)
          console.log(res);
        })
        .catch(error => {
          /*  console.log(error); */
