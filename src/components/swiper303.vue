...
<template>
  <div class="wrapper">
    ...
    <swiper :options="swiperOption" class="swiper-container" ref="mySwiper">
        ...
        <div class="lunbooutbox" @click="swiperitemtSelect(slide,index)">
          ...
          <div class="lunboinbox" :class="{'lunboinboxbox_active': i == index}">
            ...
            <div class="lunboinbox_downbox">
              <div class="lunboinbox_downbox_fontoutboxmonthnum" :id="Number(slide.MaxGrade)==1? 'grayfontcolor' :(Number(slide.MaxGrade)==2? 'bluefontcolor' :(Number(slide.MaxGrade)==3? 'redfontcolor' :''))">{{slide.Day<10?'0'+slide.Day:slide.Day}}</div>
              <div class="lunboinbox_downbox_fontoutboxweeknum" :id="Number(slide.MaxGrade)==1? 'grayfontcolor' :(Number(slide.MaxGrade)==2? 'bluefontcolor' :(Number(slide.MaxGrade)==3? 'redfontcolor' :''))">{{slide.Week}}</div>
            </div>
          </div>
        </div>
      </swiper-slide>
      ...
      <div class="swiper-button-next" slot="button-next" @mouseenter="on_top_enter" @mouseleave="on_top_leave"></div>
  </div>
</template>
